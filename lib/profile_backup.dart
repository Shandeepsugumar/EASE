        ...
        children: [
          ...
          Container(
            padding: EdgeInsets.only(
              left: 20,
              right: 20,
              top: MediaQuery.of(context).padding.top + 16, // Status bar height + padding
              bottom: 16,
            ),
            decoration: BoxDecoration(
              color: Colors.green[800], // Dark green for both themes
              boxShadow: [
                BoxShadow(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white.withOpacity(
                            0.2), // Semi-transparent white for both themes
                        borderRadius: BorderRadius.circular(12),
                      ),
                      child: Icon(
                        Icons.arrow_back_ios,
                        color: Colors.white, // White icon for both themes
                        size: 20,
                      ),
                    ),
                  ),
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.white, // White text for both themes
                      ),
                    ),
                  ),
